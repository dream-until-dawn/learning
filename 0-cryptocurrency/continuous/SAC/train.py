...
class SACLearning:
    def __init__(
        ...
        self.optimizer_value1 = torch.optim.Adam(
            model_value1.parameters(), lr=config.learning_rate_value1
        )
        self.optimizer_value2 = torch.optim.Adam(
            model_value2.parameters(), lr=config.learning_rate_value2
        )
        self.alpha = 1e-4
...
if __name__ == "__main__":
    if True:
        ...
        sacLearning = SACLearning(
            sacModel.model_action,
            sacModel.model_value1,
            sacModel.model_value2,
            sacModel.model_value1_next,
            sacModel.model_value2_next,
            player,
            pool,
        )
        sacLearning.train()
